...
C {devices/lab_pin.sym} 80 -710 0 0 {name=p3 sig_type=std_logic lab=EN1
}
...
.endc
"}
C {devices/lab_pin.sym} 230 -710 2 0 {name=p2 sig_type=std_logic lab=nEN1
}
C {sky130_tests/not.sym} 160 -590 0 0 {name=x3 m=1 
+ W_N=1 L_N=0.15 W_P=2 L_P=0.15 
+ VCCPIN=VCC VSSPIN=VSS}
C {devices/lab_pin.sym} 80 -590 0 0 {name=p4 sig_type=std_logic lab=EN2
}
C {devices/lab_pin.sym} 230 -590 2 0 {name=p5 sig_type=std_logic lab=nEN2
}
C {sky130_tests/not.sym} 160 -480 0 0 {name=x4 m=1 
+ W_N=1 L_N=0.15 W_P=2 L_P=0.15 
+ VCCPIN=VCC VSSPIN=VSS}
C {devices/lab_pin.sym} 80 -480 0 0 {name=p8 sig_type=std_logic lab=EN3
}
C {devices/lab_pin.sym} 230 -480 2 0 {name=p9 sig_type=std_logic lab=nEN3}
C {sky130_tests/not.sym} 160 -380 0 0 {name=x5 m=1 
+ W_N=1 L_N=0.15 W_P=2 L_P=0.15 
+ VCCPIN=VCC VSSPIN=VSS}
C {devices/lab_pin.sym} 80 -380 0 0 {name=p14 sig_type=std_logic lab=EN4
}
C {devices/lab_pin.sym} 230 -380 2 0 {name=p15 sig_type=std_logic lab=nEN4}
C {devices/lab_pin.sym} 260 -220 0 0 {name=p16 sig_type=std_logic lab=EN1
}
C {devices/lab_pin.sym} 210 -210 0 0 {name=p17 sig_type=std_logic lab=nEN1
}
C {devices/lab_pin.sym} 260 -190 0 0 {name=p18 sig_type=std_logic lab=EN2
}
C {devices/lab_pin.sym} 210 -180 0 0 {name=p19 sig_type=std_logic lab=nEN2
}
C {devices/lab_pin.sym} 260 -160 0 0 {name=p20 sig_type=std_logic lab=EN3}
C {devices/lab_pin.sym} 210 -150 0 0 {name=p21 sig_type=std_logic lab=nEN3
}
C {devices/lab_pin.sym} 260 -130 0 0 {name=p22 sig_type=std_logic lab=EN4
}
C {devices/lab_pin.sym} 210 -120 0 0 {name=p23 sig_type=std_logic lab=nEN4
}
...
C {devices/lab_pin.sym} 250 -100 0 0 {name=p28 sig_type=std_logic lab=IN1}
C {devices/lab_pin.sym} 250 -80 0 0 {name=p29 sig_type=std_logic lab=IN2}
C {devices/lab_pin.sym} 250 -60 0 0 {name=p30 sig_type=std_logic lab=IN3}
C {devices/lab_pin.sym} 250 -40 0 0 {name=p31 sig_type=std_logic lab=IN4}
C {devices/lab_pin.sym} 490 -100 2 0 {name=p33 sig_type=std_logic lab=OUT}
C {devices/lab_pin.sym} 480 -210 2 0 {name=p36 sig_type=std_logic lab=VCC}
C {devices/lab_pin.sym} 480 -190 2 0 {name=p37 sig_type=std_logic lab=VSS}
C {devices/launcher.sym} 900 40 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/tb_passgatex4.raw tran"
}
C {devices/res.sym} 500 20 0 0 {name=R1
value=10k
footprint=1206
device=resistor
m=1}
C {devices/lab_pin.sym} 500 80 2 0 {name=p1 sig_type=std_logic lab=VSS}
